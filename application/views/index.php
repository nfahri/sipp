   ...
   <section id="intro">
   		...
   		<div class="row">
   			...
   			<div class="col-twelve">
	   			...
	   			<div class='video-link'>
	   				<a href="#video-popup"><img src="<?php echo base_url()?>static/images/play-button.png" alt=""></a>
	   			</div>
      ...
      <div id="video-popup" class="popup-modal mfp-hide">
		   ...
		   <div class="fluid-video-wrapper">
            <iframe width="854" height="480" src="https://www.youtube.com/embed/96kI8Mp1uOU" frameborder="0" allowfullscreen></iframe> 
         </div>		     
            ...
            <ul class="slides">
               ...
               <li>
               	<div class="testimonial-author">
                    	<img src="<?php echo base_url()?>static/images/avatars/avatar-1.jpg" alt="Author image">
               ...
               <li> 
               	...
               	<div class="testimonial-author">
                    	<img src="<?php echo base_url()?>static/images/avatars/avatar-2.jpg" alt="Author image">
                    	<div class="author-info">
                    		John Doe
